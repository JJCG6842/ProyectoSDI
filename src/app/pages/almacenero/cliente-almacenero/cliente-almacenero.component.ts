...
@Component({
  selector: 'app-cliente-almacenero',
  imports: [MatIconModule, MatDialogModule, MatButtonModule,CommonModule,FormsModule,MatPaginatorModule],
  changeDetection: ChangeDetectionStrategy.OnPush,
  templateUrl: './cliente-almacenero.component.html',
  styleUrl: './cliente-almacenero.component.scss'
})
export class ClienteAlmaceneroComponent implements OnInit{
