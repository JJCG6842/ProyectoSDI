...
@Component({
  selector: 'app-view-guia',
  standalone: true,
  imports: [CommonModule, MatPaginatorModule],
  templateUrl: './view-guia.component.html',
  styleUrl: './view-guia.component.scss'
})
export class ViewGuiaComponent implements OnInit,AfterViewInit{
